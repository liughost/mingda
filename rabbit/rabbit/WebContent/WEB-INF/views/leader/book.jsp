	...
	<div class="carousel-inner">
		...
		<div class="item ">
			<a href="${context }/custom/detail_all?id=9"><img
				src="${context }/resources/custom/images/slide-08.jpg"
				alt=""></a>
			<div class="container" style="display: none;">
				<div class="carousel-caption">
		...
		<div class="item active">
			<a href="${context }/custom/detail_all?id=8"><img
				src="${context }/resources/custom/images/slide-07.jpg"
				alt=""></a>
			<div class="container" style="display: none;">
				<div class="carousel-caption">
		...
		<div class="item">
			<a href="${context }/custom/detail_all?id=3"><img
				src="${context }/resources/custom/images/slide-10.jpg"
				alt=""></a>
			<div class="container" style="display: none;">
				<div class="carousel-caption">
					<h1>夏威夷7日精彩之旅</h1>
...
<div class="container" style="max-width: ${maxWidth}px;">
	...
	<div class="row">
		...
		<div class="span2" style="width: 240px;">
			<legend>最新动态&nbsp;&nbsp;<a href="${context }/custom/articles"><span style="font-size:14px;">更多</span></a></legend>
			<table class="table">
				<tbody>
