	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="hidden" id="travlerId" name="travelerId"
				...
				value="${travelerObj.name }" onblur="check_name(this)" /><label id="username_result"></label>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="password" name="passwdconfirm" id="passwdconfirm"
				placeholder="请输入确认密码" onblur="check_pwd(this)"><label id="pwdConfirm_result"></label>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="role">
				...
				<option value="ROLE_SUPER" <c:if test="${travelerObj.role=='ROLE_SUPER'}"></c:if>>超级管理员</option>
		...
		<div class="controls">
			<select name="wxAccount">
				<c:forEach var="account" items="${accountList}" varStatus="status">
					<option value="${account.wxFromUserName }" <c:if test="${account.wxFromUserName==travelerObj.wxFromUserName}"></c:if>>${account.wxName }</option>
				</c:forEach>
			</select>
		</div>
	</div>
