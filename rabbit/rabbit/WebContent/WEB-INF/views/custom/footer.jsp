...
<div class="footerk">
			...
			<div class="footer-t">
				<div class="footer-tl">
					...
					<div class="cont">
						...
						行程具有自由、个性、灵活与可定制等特点。<br /> 我们的客户是追求人格独立和心性自由的旅行者。
					</div>
				</div>
				<div class="footer-tr">
	...
	<div class="footerk-b">
		<div class="footer">
			...
			<div class="footer-b">
				<div class="footer-bt">友情链接：<a target="_blank" href="http://usa-home.cn/">美国房产精英</a>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="http://51766.com/">51766</a></div>
				<div class="footer-bb">技术支持：北京智网明达信息技术有限公司&copy;2015
					京ICP备11001537号-3</div>
			</div>
		</div>
	</div>
</div>
...
<div id="modal1" class="modal">
	<div class="login">
		...
		<div class="loginCont loginTag">
			<ul class="login-b">
				<li><input type="text" class="loginTxt" value="登录名"
					onfocus="if(this.value=='登录名'){this.value=''}"
					onblur="if(this.value==''){this.value='登录名'}" id="username"
					name="username" tabindex="1" /> <label id="username_succeed"
					class="blank"></label>
					<div id="username_error"></div></li>
				<li><input type="text" class="loginTxt" value="密码"
					onfocus="if(this.value==defaultValue) {this.value='';this.type='password'}"
					onblur="if(!value) {value=defaultValue; this.type='text';}"
					id="pwd" name="pwd" tabindex="2" /> <label id="pwd_succeed"
					class="blank"></label> <label id="pwd_error"></label></li>
				<li>
					<div class="login-bl">
...
<div id="modal2" class="modal">
	<div class="login">
		...
		<div class="loginCont loginTag">
			<ul class="login-b">
				<li><input type="text" class="loginTxt" value="登录账户"
					onfocus="if(this.value=='登录账户'){this.value=''}"
					onblur="if(this.value==''){this.value='登录名'}" id="realname"
					name="realname" tabindex="3" /> <label id="realname_succeed"
					class="blank"></label> <label id="realname_error"></label></li>
				<li><input type="text" id="pwd2" name="pwd2" class="loginTxt"
					value="登录密码"
					onfocus="if(this.value==defaultValue) {this.value='';this.type='password'}"
					onblur="if(!value) {value=defaultValue; this.type='text';}"
					tabindex="4" /> <label id="pwd2_succeed" class="blank"></label> <label
					id="pwd2_error"></label></li>
				<li><input type="text" id="pwd3" name="pwd3" class="loginTxt"
					value="确认密码"
					onfocus="if(this.value==defaultValue) {this.value='';this.type='password'}"
					onblur="if(!value) {value=defaultValue; this.type='text';}"
					tabindex="5" /> <label id="pwd3_succeed" class="blank"></label> <label
					id="pwd3_error"></label></li>
				<li><input type="text" id="mobile" name="mobile"
					class="loginTxt2" value="有效手机号"
					onfocus="if(this.value=='有效手机号'){this.value=''}"
					onblur="if(this.value==''){this.value='有效手机号'}" tabindex="6" /> <input
					type="button" class="loginBtn3" value="获取验证码" /> <label
					id="mobile_succeed" class="blank"></label> <label id="mobile_error"></label>
				</li>
				<li><input type="text" id="authcode" name="authcode"
					class="loginTxt" value="手机验证码"
					onfocus="if(this.value=='手机验证码'){this.value=''}"
					onblur="if(this.value==''){this.value='手机验证码'}" /> <label
				...
				<li class="btny"><input type="button" class="loginBtn1"
					value="注册" /> <input type="button" class="loginBtn2" value="登录" />
				</li>
			</ul>
		</div>
	</div>
...
<div id="modal4" class="modal">
	<div class="login">
		...
		<div class="loginCont loginTag">
			<ul class="login-b">
				<li><input type="text" class="loginTxt" value="您注册时的电话号码"
					onfocus="if(this.value=='您注册时的电话号码'){this.value=''}"
					onblur="if(this.value==''){this.value='您注册时的电话号码'}" id="mobile1"
					name="mobile1" tabindex="7" /> <label id="mobile1_succeed"
					class="blank"></label> <label id="mobile1_error"></label></li>
				<li><input type="text" id="authcode1" name="authcode1"
					class="loginTxt2" value="输入验证码"
					onfocus="if(this.value=='输入验证码'){this.value=''}"
					onblur="if(this.value==''){this.value='输入验证码'}" tabindex="8" /> <input
					type="button" class="loginBtn3" value="获取验证码" /> <label
					id="authcode1_succeed" class="blank invisible"></label> <label
					id="authcode1_error"></label></li>
				<li><input type="text" id="pwd4" name="pwd4" class="loginTxt"
					value="输入新密码"
					onfocus="if(this.value==defaultValue) {this.value='';this.type='password'}"
					onblur="if(!value) {value=defaultValue; this.type='text';}"
					tabindex="9" /> <label id="pwd4_succeed" class="blank"></label> <label
					id="pwd4_error"></label></li>
				<li><input type="text" id="pwd5" name="pwd5" class="loginTxt"
					value="再次输入新密码"
					onfocus="if(this.value==defaultValue) {this.value='';this.type='password'}"
					onblur="if(!value) {value=defaultValue; this.type='text';}"
					tabindex="10" /> <label id="pwd5_succeed" class="blank"></label> <label
					id="pwd5_error"></label></li>
