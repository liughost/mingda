...
+"★ 全程中文导航及豪华保险包含，杜绝后顾之忧！");
		...
		List<DetailContext> d = new ArrayList<DetailContext>();
		 d.add(new
		 DetailContext("img","http://guantravel.com/resources/media/201410/2ad01cd869a93ddc7a73413aacc3444c.jpg"));
		d.add(new DetailContext("text", "搭乘国际航班飞往芝加哥。抵达后提车前往酒店休息。下午品尝著名的深盘Pizza，体验独特的芝加哥美食。傍晚登顶威利斯大厦(含门票)，观赏钢铁之城夜景。<br/>"
