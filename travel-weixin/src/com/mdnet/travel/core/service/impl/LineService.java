...
public class LineService extends BaseCouchService {
	...
	{
		List<ShowProductInfo> list = new ArrayList<ShowProductInfo>();
		String mapFunc = this.createSearchMapFunction(cities, scenics,
				 types,  attach);
		ViewResult<String[]> result = db.queryAdHocView(String[].class,
				mapFunc, null, null);
		for (@SuppressWarnings("rawtypes")
	...
	public String createSearchMapFunction(String[] cities, String[] scenics,
			String[] types, String attach) {
	...
	public static void main(String[] args) {
		...
		types[1] = "美食";
		//line.getByCities("", "");
		line.search(cities, scenics, types, "");
		/*
		...
		p.setFeeInclude("* 7x24小时优秀中/英双语自驾向导服务；<br/>"
				...
				+ "* 城市繁华区4钻品质酒店，小镇3钻酒店住宿；<br/>" + "* 免收每人每天8美元的导游小费；<br/>"
				+ "* 汽车租赁费及随车保险（车损或盗抢不计免赔，第三者100万美金+个人意外伤害保险+各种税费）；<br/>"
				+ "* 全程燃油/对讲机/中文导航；<br/>" + "* 中国驾照英文翻译件；<br/>"
		...
		p.setFeature("★ 全程专业自驾向导7x24小时陪同，无超时费用，省心省力、安全无忧！<br/>"
				...
				+ "★ 巨无霸越野车+燃油+豪华保险套餐+导航全部包含！<br/>" + "★ 加州一号公路穿越+大峡谷深度探秘之旅！");
		...
		d.add(new DetailContext(
				"text",
				"搭乘国际航班飞往西部名城-旧金山，抵达后，提车前往市区游览九曲花街、唐人街、联合广场等主要景点，晚上渔人码头逛街，吃海鲜。<br/>"
		...
		d.add(new DetailContext("img",
				"https://imgs.qunarzz.com/vc/ed/cf/1a/a1c23af404abbe407b1ea42108.jpg_92.jpg"));
		d.add(new DetailContext("img",
				"https://imgs.qunarzz.com/vc/76/e9/60/e0bf49cad6f54ce81d1042b14a.jpg_92.jpg"));
		j.setDetail(d);
		// 结束第一天的数据
		journey.add(j);
