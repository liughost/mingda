...
<div class="container"
	...
	<form class="form-horizontal" onsubmit="onSubmitBook()" method="POST"
		...
		<div class="control-group">
			...
			<div class="controls">
				<select style="width: 80%;" id="product"
					onchange="sel_product(this)">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label style="margin-top: 4px;" id="selGroupDate"> </label>
		...
		<div class="control-group">
			...
			<div class="controls">
				<label style="margin-top: 4px;">成人价格：<span
					style="color: orangered; font-size: 18px;" id="adultPrice"></span>&nbsp;&nbsp;
					儿童价格：<span style="color: orangered; font-size: 18px;"
					id="childrenPrice"></span> <!-- 
					&nbsp;&nbsp; 单房差价：<span
					style="color: gold; font-size: 18px;" id="hotelSpanPrice"></span>
					-->
		...
		<div class="control-group">
			<div class="controls">
				<button type="button" class="btn btn-warning"
					onclick="onSubmitBook()">报名</button>
