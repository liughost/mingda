...
var validateFunction = {
	...
	pwdstrength4:function () {

        var element = $("#pwdstrength4");
        var value = $("#pwd4").val();
        if (value.length >= 6 && validateRules.isPwd4(value)) {
            $("#pwd_error4").empty();
            element.show();
    ...
    showPassword:function (type) {
        ...
        var v3 = $("#pwd3").val(), s3 = $("#pwd3").attr("sta"), c3 = document.getElementById("pwd3").className, t3 = $("#pwd3").attr("tabindex");
        var v4 = $("#pwd4").val(), s4 = $("#pwd4").attr("sta"), c4 = document.getElementById("pwd4").className, t4 = $("#pwd4").attr("tabindex");
        var v5 = $("#pwd5").val(), s5 = $("#pwd5").attr("sta"), c5 = document.getElementById("pwd5").className, t5 = $("#pwd5").attr("tabindex");
        ...
        var P3 = $("<input type='" + type + "' value='" + v3 + "' sta='" + s3 + "' class='" + c3 + "' id='pwd3' name='pwd3' tabindex='" + t3 + "'/>");
        $("#pwd3").after(P3).remove();
        $("#pwd3").jdValidate(validatePrompt.pwd3, validateFunction.pwd3);
        var P4 = $("<input type='" + type + "' value='" + v4 + "' sta='" + s4 + "' class='" + c4 + "' id='pwd4' name='pwd4' tabindex='" + t4 + "'/>");
        $("#pwd4").after(P4).remove();
        $("#pwd4").jdValidate(validatePrompt.pwd4, validateFunction.pwd4);
        var P5 = $("<input type='" + type + "' value='" + v5 + "' sta='" + s5 + "' class='" + c5 + "' id='pwd2' name='pwd5' tabindex='" + t5 + "'/>");
        $("#pwd5").after(P5).remove();
